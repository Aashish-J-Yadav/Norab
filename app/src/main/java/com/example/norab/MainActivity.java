...
import com.example.norab.Service.OnStatusChangeListener;
								...
								public void onClick(DialogInterface dialog, int item) {
									switch (item) {
										case 0: // Donate
											...
											break;
										case 1: // Rate/Comment
											Intent iMarket = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.143aashishyadav.norab"));
								...
								public void onClick(DialogInterface dialog, int item) {
									switch (item) {
										case 0: // Google Wallet
											...
											break;
										case 1: // PayPal
											startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://paytm.me/WV-F894")));
											break;
									}
								}
							}).create();
				case WALLET:
					...
					if (walletIntent != null) {
						...
						dlg.setPositiveButton(R.string.donate_wallet_launch_web, new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog, int which) {
								startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("upi://pay?pa=8433866008@okbizaxis&pn=ASHISH%20KUMAR%20YADAV&mc=8299&aid=uGICAgMCIx-TKGg&tr=BCR2DN4TWDW4NZBB")));
							}
						});
					}
					return dlg.create();
